...
public class HillClimbingTaxicab extends CortaCespedUtils {
	 ...
	 * @param nObjetivo
	 */
	public HillClimbingTaxicab(int anchoJardin, int largoJardin, Point nObjetivo, CortaCesped cortaCesped) {
